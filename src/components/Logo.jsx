export const Logo = (props) => (
    <svg height="28" viewBox="0 0 143 50" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <title>Logo</title>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
  ...
  export const Text = (props) => (
    <svg height="24" viewBox="0 0 75 34" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <title>Logo</title>
      <path
        d="M0.736 26V0.799998H4.876V26H0.736ZM3.58 26V22.22H16.756V26H3.58Z"
        fill="var(--chakra-colors-fg)"
      />
    </svg>
  );
